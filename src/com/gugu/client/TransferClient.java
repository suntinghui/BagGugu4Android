...
import com.gugu.activity.view.PayUseBalanceDialog.OnConfirmListener;
...
public class TransferClient {
    ...
    private void requestPayUseBalance(final PayUseBalanceDialog dialog, String pwd) {
        ...
        JSONRequest request = new JSONRequest(context, RequestEnum.DEBTPACKAGE_BUY_SENDVCODE, tempMap, new Response.Listener<String>() {
