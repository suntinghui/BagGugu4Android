...
public class RegisterActivity extends BaseActivity implements OnClickListener {
    ...
    private void requestRegister() {
        ...
        JSONRequest request = new JSONRequest(this, RequestEnum.USER_REGIST_SET_PWD, tempMap, new Response.Listener<String>() {
...
//						RegisterActivity.this.startActivity(intent);
    ...
    private void requestSendSMS() {
        ...
        JSONRequest request = new JSONRequest(this, RequestEnum.USER_REGIST_SEND_SMS, tempMap, new Response.Listener<String>() {
    ...
    private void setClickableSpan() {
        String htmlLinkText = "注册即代表您同意《鼓鼓投资协议》";
