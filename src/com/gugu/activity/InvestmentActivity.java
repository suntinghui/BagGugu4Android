...
import com.ares.baggugu.dto.app.DebtPackageListCountDownAppDto;
import com.gugu.activity.view.InvestmentCurrentLayout;
import com.gugu.activity.view.InvestmentScheduledLayout;
...
public class InvestmentActivity extends BaseActivity implements OnClickListener {
    ...
    private void initView() {
        ...
        if (this.type == TYPE_HQ) {
            titleTextView.setText("鼓鼓活期");
        } else {
            titleTextView.setText("鼓鼓定期");
        }
