...
public class NotFirstPayActivity extends BaseActivity implements OnClickListener {
	...
	private void requestSendCode() {
		JSONRequest request = new JSONRequest(this, RequestEnum.DEBTPACKAGE_BUY_SENDVCODE, getRequestMap(), false, false, new Response.Listener<String>() {
	...
	private void requestPay() {
		...
		JSONRequest request = new JSONRequest(this, RequestEnum.DEBTPACKAGE_BUY, tempMap, false, false, new Response.Listener<String>() {
